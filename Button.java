...
public class Button extends Actor
{
    ...
    public Button(int fs, String f, String s, String t)
    {
        ...
        text1 = new GreenfootImage(t, fs, Color.WHITE, new Color(0, 0, 0, 0));
        text2 = new GreenfootImage(t, fs, Color.BLACK, new Color(0, 0, 0, 0));
    ...
    private Button( String f, String s)
    {
        firstImage = f;
        secondImage = s;
